...
the hydrogen \change{ionisation} limit \citep{Woods_2018}. \\
...
(IMBHs) with masses ranging from 1000 \msolar to several thousand \msolarc. \jhw{We could use 300 \msolar as a lower limit because these are still technically IMBHs.} The subsequent
