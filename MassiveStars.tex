...
\begin{abstract}
  We investigate the ab-initio formation of super-massive stars in a pristine atomic cooling halo. The halo is
  extracted from a larger self-consistent parent simulation. The halo remain metal-free and star formation is suppressed
  due to a combination of dynamical heating from mergers and a mild (J$_{LW} \sim 2 - 10 J_{21}$(z)) Lyman-Werner background.
  We also simulate another pristine halo without any LW background as a control halo. We find that in the halo that is
  exposed to a LW background and is impacted by dynamical heating that more than 20 very massive stars form with stellar
  masses greater than 1000 \msolarc. The most massive star has a stellar mass of 6128 \msolar. However, accretion onto
  all stars declines significantly after the first 10 - 20 kyr of evolution as the surrounding material is accreted and
  the turbulent nature of the gas causes the stars to move to lower density regions. We post-process the impact of ionising
  radiation from the stars and find that the ionising radiation is not a limiting factor when considering SMS formation
  and growth. Rather the birth environments are highly turbulent and a steady accretion flow is not maintained within
  the timescale (2 Myrs) of our simulations. As the massive stars end their lives as direct collapse black holes this
  will sees these embryonic haloes with a population of black holes with masses between 1000 \msolar and 10000 \msolar
  which may then go on to sink to the centre of the haloes eventually coalescing to form larger intermediate mass
  black holes. 
...
%{\bf TEW: need to do one more pass to clean up a bit, maybe add a couple sentences on a few of the other tests we did, but just about there.}
