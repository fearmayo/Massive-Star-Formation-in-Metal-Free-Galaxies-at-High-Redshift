...
The original Renaissance simulations were carried out on the Blue Waters supercomputer 
...
was then smoothed on a scale\footnote{All distance units quoted are physical units unless explicitly stated otherwise.} of 5 comoving Mpc, and regions of high
...
average ($\langle\delta\rangle \sim 0.09$), and low ($\langle\delta\rangle \simeq -0.26$)
 mean total matter density (i.e., baryons + dark matter) were chosen for re-simulation. 
...
remained metal-free. \hb, on the other hand, collapses early in a
halo with a mass of a few times $10^6$ \msolar due to the lack of LW background and thus can be classified as a mini-halo. \jhw{Give halo masses instead of approximate values.} Before analysing the star formation in detail we use results from \cloudy to determine when the negative feedback from stars eventually
