...
of $10^{15}$ cm ($3 \times 10^{-4}$ pc) and terminate our calculations at the outer boundary of
...
\jr{Tyrone I think we should change the argument here to be along the lines of ``For \ha and \hb
  ...
  neglibible implying that although the impact of ionising radiation is neglected in our
  simulations the impact of neglecting this process is neglibible. We do find that within 1 pc of each star the gas becomes ionised but that dense gas beyond this radius is able to self-shield....''. What do you think?}\\
...
after the formation of the first star while. In both cased we terminate the simulations
...
The most massive star in \ha at the final output time is 6127 \msolar with another star with a mass
