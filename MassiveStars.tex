...
that critical level of $n_{gas} \gtrsim 10^6$ (see Figure \ref{Fig:ProjectionEnd}) in the centre of the halo)
...
centres \citep[e.g.][]{Gultekin_2006}, \textbf{however we consider the case of a binary black hole
merger with a mass ratio, $q = 1$ and hence in this case ejections can be avoided \citep{Holley-Bockelmann_2008}.}
...
of detections by LISA is now underway (Arridge et al. in prep). \textbf{The merger of less
