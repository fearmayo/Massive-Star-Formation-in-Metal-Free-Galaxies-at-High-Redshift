...
(IMBHs) with masses ranging from 1000 \msolar to several thousand \msolarc. The subsequent
...
formulae from \cite{Stahler_1986}. The collisonal time, plotted in blue, is a measure of time
required for one
...
is approximately 33 and hence well within LISA's detection parameters\footnote{The SNR was calculated
  using the LISA sensitivity calculatorg available at
...
tend to host a small number of stars with peak masses in the raneg of a few tens of
