...
other stars are coloured in orange and not distinguished. Note that each of the \jhw{Did orange refer to an old version of the plot?} orange stars undergoes
a ``bump'' in its accretion rate independent of the initial high accretion rate value (top left panel
...
spirit to what \cite{Smith_2018} found for accretion stellar mass black holes in similar high-z environments.}\\
...
\caption{\jhw{Choose different colors, especially the yellow. The default matplotlib ones are fine.} The evolution of the most massive star in \ha and seven other stars which
  cross regions of high density during their evolution resulting in enhanced accretion rates.
  The accretion rate for each star (most massive in blue) is shown in the
  top left panel. The final mass of each star ranges from approximately 1000 \msolar up to 6127
  \msolarc. Each of the stars (with the exception of the most massive star) shows a second
  spike of $\dot{M} \gtrsim 10^-3$ \msolaryr during its evolution. For most stars this
  happens a few hundred kyrs after formation. This spike in accretion is caused by the star
  ...
  clump varies. Note that for the most massive star, shown in blue, the stellar
